...
extern r_obj* ffi_list_unchop(r_obj*, r_obj*, r_obj*, r_obj*, r_obj*, r_obj*, r_obj*, r_obj*);
...
extern r_obj* ffi_recode_values(r_obj*, r_obj*, r_obj*, r_obj*, r_obj*, r_obj*, r_obj*, r_obj*);
...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"ffi_list_unchop",                           (DL_FUNC) &ffi_list_unchop, 8},
  ...
  {"ffi_recode_values",                         (DL_FUNC) &ffi_recode_values, 8},
