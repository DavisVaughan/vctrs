...
// This is really `p_df_is_incomplete()`
static
...
static bool p_df_is_missing2(const void* x, r_ssize i);

// [[ include("poly-op.h") ]]
poly_unary_bool_fn_ptr new_poly_p_is_missing2(enum vctrs_type type) {
  switch (type) {
  case vctrs_type_null: return p_nil_is_missing;
  case vctrs_type_logical: return p_lgl_is_missing;
  case vctrs_type_integer: return p_int_is_missing;
  ...
  case vctrs_type_raw: return p_raw_is_missing;
  case vctrs_type_list: return p_list_is_missing;
  case vctrs_type_dataframe: return p_df_is_missing2;
  default: stop_unimplemented_vctrs_type("new_poly_p_is_missing2", type);
  }
}

static
bool p_df_is_missing2(const void* x, r_ssize i) {
  struct poly_df_data* x_data = (struct poly_df_data*) x;
