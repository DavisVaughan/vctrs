...
#' @param default If `NULL`, a missing value is used as the default value not
#'   covered by any location in `indices`, otherwise the provided `default` is
#'   used. If provided, `size` must also be provided, and `default` must be size
#'   1 or size `size`.
...
list_unchop <- function(x,
  ...
  check_dots_empty0(...)
  .Call(ffi_list_unchop, x, indices, default, ptype, size, name_spec, name_repair, environment())
}
