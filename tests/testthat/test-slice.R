...
test_that("can subset object of any dimensionality with compact seqs", {
  ...
  expect_equal(vec_slice_seq(x0, 0L, 0L), 1)
  expect_identical(vec_slice_seq(x1, 0L, 0L), ones(1))
  expect_identical(vec_slice_seq(x2, 0L, 0L), ones(1, 3))
  expect_identical(vec_slice_seq(x3, 0L, 0L), ones(1, 3, 4))
  expect_identical(vec_slice_seq(x4, 0L, 0L), ones(1, 3, 4, 5))
})
